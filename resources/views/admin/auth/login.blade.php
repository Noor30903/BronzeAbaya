...
<head>
  ...
  <title>BronzeAbaya | Log in</title>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="{{url('public/{{ url ( ' ' ) }}/assets/plugins/icheck-bootstrap/icheck-bootstrap.min.css')}}">
  <!-- Theme style -->
...
<!-- AdminLTE App -->
<script src="{{url('public/{{ url ( ' ' ) }}/assets/dist/js/adminlte.min.js')}}"></script>
</body>
</html>
