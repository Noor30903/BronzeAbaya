            ...
            <div class="card">
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-striped table-valign-middle">
                  ...
                  <tr>
                    <td>
                      <img src="{{url('public/{{ url ( ' ' ) }}/assets/dist/img/default-150x150.png')}}" alt="Product 1" class="img-circle img-size-32 mr-2">
                      Some Product
                    </td>
                    <td>$13 USD</td>
                    <td>
...
@section('script')
<script src="{{ url('public/{{ url ( ' ' ) }}/assets/dist/js/pages/dashboard3.js')}}"></script>
@endsection